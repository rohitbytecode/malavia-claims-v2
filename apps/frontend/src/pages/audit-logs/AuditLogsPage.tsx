  ...
  const renderDataDiff = (prev: any, curr: any) => {
    ...
    if (diffs.length === 0) {
      return (
        ...
        >
          No field changes detected or object was created/deleted without
  ...
  return (
    <div className="page-stack">
      ...
      <div className="page-title">
        ...
        <h1>Audit Logs</h1>
        <span>
          Track and review every action performed by operators, claim
            ...
            <table className="dt-table dt-table--compact">
              <thead>
                <tr>
                  ...
                  <th className="dt-th" style={{ textAlign: "right" }}>
                    Details
                  </th>
                </tr>
              </thead>
      ...
      {selectedLog && (
        ...
        >
          ...
          >
            ...
            >
              <div>
                ...
                <div>
                  ...
                  {selectedLog.performedBy?.username ?? "system"})
                </div>
              </div>
              <div>
            ...
            <h3 style={{ fontSize: "14px", margin: "16px 0 8px 0" }}>
              Changes State Comparison
            </h3>
