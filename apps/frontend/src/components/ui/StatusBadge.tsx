...
const tone: Partial<Record<ClaimStatus | AlertSeverity | string, string>> = {
  DRAFT: "neutral",
  PREAUTH_PENDING: "warning",
  PREAUTH_APPROVED: "success",
  PREAUTH_REJECTED: "danger",
  RECONSIDERATION_PENDING: "warning",
